...
//        titles.add("已取消");
        ...
        List<ConfigBean.Config> configList = new ArrayList<>();
        for (int i = 0; i < AppConfig.getInstance().getConfigBean().getTypeId_122().size()-1; i++) {
            configList.add(AppConfig.getInstance().getConfigBean().getTypeId_122().get(i));
        }
